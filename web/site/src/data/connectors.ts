...
export const connectors: Connector[] = [
  { slug: 'filesystem', name: 'Filesystem', category: 'local', firstParty: true, auth: 'none', runtime: 'native',
  ...
  { slug: 'code-editor', name: 'Code editor', category: 'local', firstParty: true, auth: 'none', runtime: 'native',
  ...
  { slug: 'shell', name: 'Shell', category: 'local', firstParty: true, auth: 'none', runtime: 'native',
  ...
  { slug: 'web', name: 'Web', category: 'local', firstParty: true, auth: 'none', runtime: 'native',
  ...
  { slug: 'github', name: 'GitHub', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://github.com',
  ...
  { slug: 'gitlab', name: 'GitLab', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://gitlab.com',
  ...
  { slug: 'linear', name: 'Linear', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://linear.app',
  ...
  { slug: 'jira', name: 'Jira', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://www.atlassian.com/software/jira',
  ...
  { slug: 'sentry', name: 'Sentry', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://sentry.io',
  ...
  { slug: 'vercel', name: 'Vercel', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://vercel.com',
  ...
  { slug: 'cloudflare', name: 'Cloudflare', category: 'developer', auth: 'oauth', runtime: 'mcp-remote', website: 'https://www.cloudflare.com',
    does: 'Workers, DNS and Pages',
    summary: 'Workers, Pages, DNS records and analytics for your zones. Changes to DNS are external writes.',
    capabilities: ['list_workers', 'get_worker_logs', 'list_dns_records', 'create_dns_record'] },
  { slug: 'playwright', name: 'Playwright', category: 'developer', icon: false, auth: 'none', runtime: 'mcp-stdio', website: 'https://playwright.dev',
  ...
  { slug: 'docker', name: 'Docker', category: 'developer', auth: 'none', runtime: 'mcp-stdio', website: 'https://www.docker.com',
  ...
  { slug: 'context7', name: 'Context7', category: 'developer', icon: false, auth: 'none', runtime: 'mcp-remote', website: 'https://context7.com',
  ...
  { slug: 'google-drive', name: 'Google Drive', category: 'productivity', auth: 'oauth', runtime: 'mcp-stdio', website: 'https://drive.google.com',
  ...
  { slug: 'google-calendar', name: 'Google Calendar', category: 'productivity', auth: 'oauth', runtime: 'mcp-stdio', website: 'https://calendar.google.com',
  ...
  { slug: 'gmail', name: 'Gmail', category: 'productivity', auth: 'oauth', runtime: 'mcp-stdio', website: 'https://mail.google.com',
  ...
  { slug: 'notion', name: 'Notion', category: 'productivity', auth: 'oauth', runtime: 'mcp-remote', website: 'https://www.notion.so',
  ...
  { slug: 'figma', name: 'Figma', category: 'productivity', auth: 'oauth', runtime: 'mcp-remote', website: 'https://www.figma.com',
  ...
  { slug: 'asana', name: 'Asana', category: 'productivity', auth: 'oauth', runtime: 'mcp-remote', website: 'https://asana.com',
  ...
  { slug: 'todoist', name: 'Todoist', category: 'productivity', auth: 'api-key', runtime: 'mcp-stdio', website: 'https://todoist.com',
  ...
  { slug: 'supabase', name: 'Supabase', category: 'data', auth: 'oauth', runtime: 'mcp-remote', website: 'https://supabase.com',
  ...
  { slug: 'postgresql', name: 'PostgreSQL', category: 'data', auth: 'connection-string', runtime: 'mcp-stdio', website: 'https://www.postgresql.org',
  ...
  { slug: 'mongodb', name: 'MongoDB', category: 'data', auth: 'connection-string', runtime: 'mcp-stdio', website: 'https://www.mongodb.com',
  ...
  { slug: 'neon', name: 'Neon', category: 'data', auth: 'oauth', runtime: 'mcp-remote', website: 'https://neon.com',
  ...
  { slug: 'airtable', name: 'Airtable', category: 'data', auth: 'api-key', runtime: 'mcp-stdio', website: 'https://airtable.com',
  ...
  { slug: 'stripe', name: 'Stripe', category: 'data', auth: 'api-key', runtime: 'mcp-remote', website: 'https://stripe.com',
  ...
  { slug: 'slack', name: 'Slack', category: 'communication', icon: false, auth: 'oauth', runtime: 'mcp-stdio', website: 'https://slack.com',
  ...
  { slug: 'discord', name: 'Discord', category: 'communication', auth: 'api-key', runtime: 'mcp-stdio', website: 'https://discord.com',
  ...
  { slug: 'microsoft-teams', name: 'Microsoft Teams', category: 'communication', icon: false, auth: 'oauth', runtime: 'mcp-stdio', website: 'https://www.microsoft.com/microsoft-teams',
  ...
  { slug: 'brave-search', name: 'Brave Search', category: 'web', icon: 'brave', auth: 'api-key', runtime: 'mcp-stdio', website: 'https://brave.com/search/api/',
  ...
  { slug: 'exa', name: 'Exa', category: 'web', icon: false, auth: 'api-key', runtime: 'mcp-remote', website: 'https://exa.ai',
  ...
  { slug: 'firecrawl', name: 'Firecrawl', category: 'web', icon: false, auth: 'api-key', runtime: 'mcp-remote', website: 'https://firecrawl.dev',
  ...
  { slug: 'tavily', name: 'Tavily', category: 'web', icon: false, auth: 'api-key', runtime: 'mcp-remote', website: 'https://tavily.com',

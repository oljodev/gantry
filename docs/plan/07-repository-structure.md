...
│   │       ├── routes/                   # TanStack file routes: __root, index, chat.index, chat.$chatId, code.index, code.$sessionId, projects, artifacts, artifact-window, incognito, onboarding, dev.gallery; routeTree.gen.ts is generated. Settings and Customize are dialogs, not routes (15 A18)

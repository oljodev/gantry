...
| **B8** | Remote, OAuth client you supply | BigQuery, Cloud Run, and whichever others answer | Not shipped, and smaller than it looked: of the `https://<service>.googleapis.com/mcp` endpoints §2 recorded, BigQuery answers and **Drive and Calendar are 404** (checked 2026-09-12). Gmail and Drive have no official server at all, so this batch is a handful of Google Cloud services rather than Workspace |

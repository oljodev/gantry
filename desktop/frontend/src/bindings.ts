...
export const commands = {
  ...
  updateSettings: (patch: SettingsPatch) =>
    typedError<Settings, ErrorDto>(__TAURI_INVOKE('update_settings', { patch })),
  ...
  listGuardDecisions: (limit: number) =>
    typedError<GuardDecision[], ErrorDto>(__TAURI_INVOKE('list_guard_decisions', { limit })),
  getSecretStoreStatus: () =>
    typedError<SecretStoreStatus, ErrorDto>(__TAURI_INVOKE('get_secret_store_status')),
  ...
  backupDatabase: (path: string) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('backup_database', { path })),
  ...
  setProviderKey: (providerId: ProviderId, key: string) =>
    typedError<KeyStatus, ErrorDto>(__TAURI_INVOKE('set_provider_key', { providerId, key })),
  clearProviderKey: (providerId: ProviderId) =>
    typedError<KeyStatus, ErrorDto>(__TAURI_INVOKE('clear_provider_key', { providerId })),
  /**  Checks the key with the provider's cheapest call and reports the error class on failure. */
  testProvider: (providerId: ProviderId) =>
    typedError<ProviderTest, ErrorDto>(__TAURI_INVOKE('test_provider', { providerId })),
  /**
   *  The provider's model list from the cache, or fresh when `refresh` is set or the cache is
   *  stale (docs/plan/02 §2).
   */
  listModels: (providerId: ProviderId, refresh: boolean) =>
    typedError<ModelInfo[], ErrorDto>(__TAURI_INVOKE('list_models', { providerId, refresh })),
  updateProvider: (providerId: ProviderId, update: ProviderUpdate) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('update_provider', { providerId, update })),
  /**
   ...
   */
  addCustomProvider: (endpoint: CustomEndpoint) =>
    typedError<ProviderId, ErrorDto>(__TAURI_INVOKE('add_custom_provider', { endpoint })),
  /**  Removes a custom endpoint and its key; the built-in accounts stay. */
  removeProvider: (providerId: ProviderId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('remove_provider', { providerId })),
  /**
  ...
  createChat: (
    ...
    surface:
      ...
      | null,
    roots: string[] | null,
  ) => typedError<ChatSummary, ErrorDto>(__TAURI_INVOKE('create_chat', { model, surface, roots })),
  /**
   ...
   */
  blobImage: (hash: string, mime: string) =>
    __TAURI_INVOKE<string | null>('blob_image', { hash, mime }),
  /**
   ...
   */
  blobMedia: (hash: string, mime: string) =>
    __TAURI_INVOKE<string | null>('blob_media', { hash, mime }),
  ...
  listChats: (
    surface:
      ...
      | 'code'
      | null,
  ) => typedError<ChatSummary[], ErrorDto>(__TAURI_INVOKE('list_chats', { surface })),
  /**  Every file this session changed and has not put back, most recently changed first. */
  sessionChanges: (chatId: ChatId) =>
    typedError<FileChangeDto[], ErrorDto>(__TAURI_INVOKE('session_changes', { chatId })),
  /**  One file's diff, from what it was before this session to what it is now. */
  sessionFileDiff: (chatId: ChatId, path: string) =>
    typedError<FileDiffDto, ErrorDto>(__TAURI_INVOKE('session_file_diff', { chatId, path })),
  /**  Puts one file back to what it was before this session touched it. */
  revertFile: (chatId: ChatId, path: string) =>
    typedError<RevertedDto, ErrorDto>(__TAURI_INVOKE('revert_file', { chatId, path })),
  /**
   ...
   */
  revertSession: (chatId: ChatId) =>
    typedError<RevertAllDto, ErrorDto>(__TAURI_INVOKE('revert_session', { chatId })),
  /**
   ...
   */
  addChatRoot: (chatId: ChatId, path: string) =>
    typedError<string[], ErrorDto>(__TAURI_INVOKE('add_chat_root', { chatId, path })),
  /**  Removes a folder. A code session may not drop its last one: it would stop being one. */
  removeChatRoot: (chatId: ChatId, path: string) =>
    typedError<string[], ErrorDto>(__TAURI_INVOKE('remove_chat_root', { chatId, path })),
  getChat: (chatId: ChatId) =>
    typedError<ChatDetail_Serialize, ErrorDto>(__TAURI_INVOKE('get_chat', { chatId })),
  updateChat: (chatId: ChatId, update: ChatUpdate) =>
    typedError<ChatSummary, ErrorDto>(__TAURI_INVOKE('update_chat', { chatId, update })),
  deleteChat: (chatId: ChatId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('delete_chat', { chatId })),
  /**  The user's verdict on a reply; `None` clears it. */
  rateTurn: (chatId: ChatId, turnId: TurnId, feedback: 'good' | 'bad' | null) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('rate_turn', { chatId, turnId, feedback })),
  /**  Chats by title and messages by text (15 A15). */
  search: (query: string, limit: number) =>
    typedError<SearchHit[], ErrorDto>(__TAURI_INVOKE('search', { query, limit })),
  /**  The assembled system prompt of a chat, read-only (11 §2, Advanced → developer mode). */
  getSystemPrompt: (chatId: ChatId) =>
    typedError<SystemPromptView, ErrorDto>(__TAURI_INVOKE('get_system_prompt', { chatId })),
  /**  Writes the chat to `path` as Markdown or JSON (11 §2, Data & privacy). */
  exportChat: (chatId: ChatId, format: ExportFormat, path: string) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('export_chat', { chatId, format, path })),
  /**
  ...
  sendMessage: (
    ...
    skills: string[],
    onEvent: Channel<AgentEventBatch_Deserialize>,
  ) =>
    typedError<TurnId, ErrorDto>(
      __TAURI_INVOKE('send_message', { chatId, text, attachments, skills, onEvent }),
    ),
  /**  Drops the chat's last turn and sends its user message again over a fresh channel. */
  retryTurn: (chatId: ChatId, turnId: TurnId, onEvent: Channel<AgentEventBatch_Deserialize>) =>
    typedError<TurnId, ErrorDto>(__TAURI_INVOKE('retry_turn', { chatId, turnId, onEvent })),
  /**
  ...
  allowBlockedCall: (
    ...
    typedError<TurnId, ErrorDto>(__TAURI_INVOKE('allow_blocked_call', { chatId, callId, onEvent })),
  /**
   ...
   */
  markJudgeDecision: (callId: CallId, wrong: boolean | null) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('mark_judge_decision', { callId, wrong })),
  /**  Whether the turn was running. */
  cancelTurn: (turnId: TurnId) =>
    typedError<boolean, ErrorDto>(__TAURI_INVOKE('cancel_turn', { turnId })),
  /**  Reattaches to a running turn: one snapshot, then live batches (05 §3). */
  subscribeTurn: (
    turnId: TurnId,
    sinceSeq: number,
    onEvent: Channel<AgentEventBatch_Deserialize>,
  ) => typedError<null, ErrorDto>(__TAURI_INVOKE('subscribe_turn', { turnId, sinceSeq, onEvent })),
   ...
   */
  listPendingInteractions: (chatId: string | null) =>
    typedError<Interaction[], ErrorDto>(__TAURI_INVOKE('list_pending_interactions', { chatId })),
  /**  Answers a pending decision; the waiting turn continues. */
  resolveInteraction: (interactionId: InteractionId, resolution: InteractionResolution) =>
    typedError<Interaction, ErrorDto>(
      __TAURI_INVOKE('resolve_interaction', { interactionId, resolution }),
    ),
  /**  The chat's standing permissions (04 §8), oldest first, for the Permissions panel. */
  listChatGrants: (chatId: ChatId) =>
    typedError<ChatGrant[], ErrorDto>(__TAURI_INVOKE('list_chat_grants', { chatId })),
  /**  Revokes one standing permission. The next call it would have covered asks again. */
  revokeChatGrant: (grantId: GrantId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('revoke_chat_grant', { grantId })),
  /**  Revokes every standing permission of one chat. */
  revokeAllChatGrants: (chatId: ChatId) =>
    typedError<number, ErrorDto>(__TAURI_INVOKE('revoke_all_chat_grants', { chatId })),
  /**  One tool call with its full result, for the detail pane of a finished turn. */
  getToolCall: (callId: CallId) =>
    typedError<ToolCallDto, ErrorDto>(__TAURI_INVOKE('get_tool_call', { callId })),
  /**
   *  Artifacts of one chat (oldest first), of one project, or of every chat (the library,
   *  newest change first).
   */
  listArtifacts: (chatId: string | null, projectId: string | null) =>
    typedError<ArtifactDto[], ErrorDto>(__TAURI_INVOKE('list_artifacts', { chatId, projectId })),
  /**  The current version with its history. */
  getArtifact: (artifactId: ArtifactId) =>
    typedError<ArtifactContent, ErrorDto>(__TAURI_INVOKE('get_artifact', { artifactId })),
  getArtifactVersion: (artifactId: ArtifactId, version: number) =>
    typedError<ArtifactContent, ErrorDto>(
      __TAURI_INVOKE('get_artifact_version', { artifactId, version }),
    ),
  /**  The user saved the source in the panel: a `user_edit` version plus the transcript note. */
  saveArtifactVersion: (artifactId: ArtifactId, content: string) =>
    typedError<ArtifactContent, ErrorDto>(
      __TAURI_INVOKE('save_artifact_version', { artifactId, content }),
    ),
  /**  A new version with an earlier version's content (13 §7). */
  restoreArtifactVersion: (artifactId: ArtifactId, version: number) =>
    typedError<ArtifactContent, ErrorDto>(
      __TAURI_INVOKE('restore_artifact_version', { artifactId, version }),
    ),
  /**  Writes one version to a file the user picks; `None` when the dialog was dismissed. */
  exportArtifact: (artifactId: ArtifactId, version: number | null) =>
    typedError<string | null, ErrorDto>(__TAURI_INVOKE('export_artifact', { artifactId, version })),
  /**  The panel's report for one version: completes a tool result waiting on it (13 §2). */
  reportArtifactRender: (artifactId: ArtifactId, version: number, report: RenderReport) =>
    typedError<boolean, ErrorDto>(
      __TAURI_INVOKE('report_artifact_render', { artifactId, version, report }),
    ),
  /**
   ...
   */
  openArtifactWindow: (artifactId: ArtifactId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('open_artifact_window', { artifactId })),
  listCatalog: () => typedError<CatalogEntryDto[], ErrorDto>(__TAURI_INVOKE('list_catalog')),
  listConnectors: () =>
    typedError<ConnectorInstanceDto[], ErrorDto>(__TAURI_INVOKE('list_connectors')),
  getConnector: (instanceId: InstanceId) =>
    typedError<ConnectorInstanceDto, ErrorDto>(__TAURI_INVOKE('get_connector', { instanceId })),
  /**
   ...
   */
  checkRuntimes: (catalogId: string) =>
    typedError<RuntimeStatus[], ErrorDto>(__TAURI_INVOKE('check_runtimes', { catalogId })),
  /**
   ...
   */
  connectorLogs: (instanceId: InstanceId) =>
    typedError<string[], ErrorDto>(__TAURI_INVOKE('connector_logs', { instanceId })),
  /**
   ...
   */
  getConnectorConfig: (catalogId: string, instanceId: string | null) =>
    typedError<ConnectorConfigForm, ErrorDto>(
      __TAURI_INVOKE('get_connector_config', { catalogId, instanceId }),
    ),
  setConnectorConfig: (instanceId: InstanceId, values: { [key in string]: string }) =>
    typedError<ConnectorInstanceDto, ErrorDto>(
      __TAURI_INVOKE('set_connector_config', { instanceId, values }),
    ),
  installConnector: (catalogId: string) =>
    typedError<ConnectorInstanceDto, ErrorDto>(__TAURI_INVOKE('install_connector', { catalogId })),
  installCustomConnector: (server: CustomServer) =>
    typedError<ConnectorInstanceDto, ErrorDto>(
      __TAURI_INVOKE('install_custom_connector', { server }),
    ),
  /**  Connects and refreshes the tool list. */
  connectConnector: (instanceId: InstanceId) =>
    typedError<ToolInfo[], ErrorDto>(__TAURI_INVOKE('connect_connector', { instanceId })),
  /**
   ...
   */
  authorizeConnector: (instanceId: InstanceId, clientId: string | null) =>
    typedError<ConnectorInstanceDto, ErrorDto>(
      __TAURI_INVOKE('authorize_connector', { instanceId, clientId }),
    ),
  /**  Stores a pasted token or key and connects with it. */
  setConnectorToken: (instanceId: InstanceId, token: string) =>
    typedError<ConnectorInstanceDto, ErrorDto>(
      __TAURI_INVOKE('set_connector_token', { instanceId, token }),
    ),
  setConnectorEnabled: (instanceId: InstanceId, enabled: boolean) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('set_connector_enabled', { instanceId, enabled })),
  /**  Uninstalls: the credentials go, the registered clients go, the history stays readable. */
  removeConnector: (instanceId: InstanceId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('remove_connector', { instanceId })),
  /**
   *  Which connectors a chat may use (03 §11: installing something never changes what an
   *  existing conversation can reach).
   */
  listChatConnectors: (chatId: ChatId) =>
    typedError<InstanceId[], ErrorDto>(__TAURI_INVOKE('list_chat_connectors', { chatId })),
  attachConnector: (chatId: ChatId, instanceId: InstanceId, attached: boolean) =>
    typedError<InstanceId[], ErrorDto>(
      __TAURI_INVOKE('attach_connector', { chatId, instanceId, attached }),
    ),
  /**
  ...
  saveSkill: (input: SkillInput) =>
    typedError<SkillDto, ErrorDto>(__TAURI_INVOKE('save_skill', { input })),
  ...
  setSkillEnabled: (id: string, enabled: boolean) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('set_skill_enabled', { id, enabled })),
  testSkillMatch: (id: string, message: string) =>
    typedError<MatchResult, ErrorDto>(__TAURI_INVOKE('test_skill_match', { id, message })),
  /**
   ...
   */
  exportSkill: (id: string, path: string) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('export_skill', { id, path })),
  ...
  reviewSkill: (path: string | null, text: string | null) =>
    typedError<SkillReview, ErrorDto>(__TAURI_INVOKE('review_skill', { path, text })),
  /**
   ...
   */
  reviewSkillUrl: (url: string) =>
    typedError<SkillReview, ErrorDto>(__TAURI_INVOKE('review_skill_url', { url })),
  /**
   ...
   */
  installSkill: (name: string, text: string, references: SkillReference[]) =>
    typedError<SkillDto, ErrorDto>(__TAURI_INVOKE('install_skill', { name, text, references })),
  /**  The skills pinned to one chat (12 §A6). A pinned skill is in that chat's frozen prompt. */
  listChatSkills: (chatId: ChatId) =>
    typedError<string[], ErrorDto>(__TAURI_INVOKE('list_chat_skills', { chatId })),
  pinSkillToChat: (chatId: ChatId, skillId: string, pinned: boolean) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('pin_skill_to_chat', { chatId, skillId, pinned })),
  listMemories: (query: MemoryQuery) =>
    typedError<MemoryDto[], ErrorDto>(__TAURI_INVOKE('list_memories', { query })),
  /**
   *  Writes one entry the user asked for: the page's New, `/remember`, or **Remember this** on a
   *  selection.
   */
  createMemory: (memory: NewMemory) =>
    typedError<MemoryDto, ErrorDto>(__TAURI_INVOKE('create_memory', { memory })),
  updateMemory: (id: MemoryId, patch: MemoryInput) =>
    typedError<MemoryDto, ErrorDto>(__TAURI_INVOKE('update_memory', { id, patch })),
  /**  Deletes into Recently deleted, where it stays for thirty days (12 §B5). */
  deleteMemory: (id: MemoryId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('delete_memory', { id })),
  restoreMemory: (id: MemoryId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('restore_memory', { id })),
  /**  Removes an entry for good, from Recently deleted. There is nowhere after this. */
  forgetMemoryForGood: (id: MemoryId) =>
    typedError<null, ErrorDto>(__TAURI_INVOKE('forget_memory_for_good', { id })),
  /**
  ...
  exportMemories: (path: string) =>
    typedError<number, ErrorDto>(__TAURI_INVOKE('export_memories', { path })),
  /**
   *  Reads an export back for review. The file dialog picked it; nothing is written until the
   *  user confirms what it holds.
   */
  readMemoryExport: (path: string) =>
    typedError<string, ErrorDto>(__TAURI_INVOKE('read_memory_export', { path })),
  reviewMemoryImport: (json: string) =>
    typedError<MemoryImport, ErrorDto>(__TAURI_INVOKE('review_memory_import', { json })),
  /**
   ...
   */
  importMemories: (entries: MemoryDto[]) =>
    typedError<number, ErrorDto>(__TAURI_INVOKE('import_memories', { entries })),
};
...
export type AgentEventKind_Deserialize =
  | ({ type: 'turn.started'; chat_id: ChatId; mode: Mode; guard: boolean; model: ModelRef } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
      ...
      message?: never;
      message_id?: never;
      model_tool_name?: never;
      part?: never;
      resolution?: never;
      result?: never;
      result_preview?: never;
      retryable?: never;
      role?: never;
      snapshot?: never;
      source?: never;
  ...
  | ({ type: 'message.started'; message_id: MessageId; role: Role } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
  ...
  | ({ type: 'text.delta'; message_id: MessageId; block: number; text: string } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      call_id?: never;
  ...
  | ({ type: 'thinking.delta'; message_id: MessageId; block: number; text: string } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      call_id?: never;
  ...
  | ({ type: 'block.done'; message_id: MessageId; block: number; part: ContentPart_Deserialize } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      call_id?: never;
  ...
  | ({ type: 'tool_call.args_delta'; call_id: CallId; fragment: string } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
  ...
  | ({ type: 'decision.requested'; interaction: Interaction } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
   ...
   */
  | ({ type: 'judge.decision'; call_id: CallId; verdict: JudgeVerdict } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
   ...
   */
  | ({ type: 'tool_call.output'; call_id: CallId; stream: ToolStream; chunk: string } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
  ...
  | ({ type: 'provider.notice'; kind: string; detail: string } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
   ...
   */
  | ({ type: 'context.injected'; injected: InjectedContext } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
  ...
  | ({ type: 'turn.snapshot'; snapshot: TurnSnapshot_Deserialize } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      block?: never;
...
export type AgentEventKind_Serialize =
  ...
  /**  A block is complete; its final part is authoritative. */
  | ({ type: 'block.done'; message_id: MessageId; block: number; part: ContentPart_Serialize } & {
      args?: never;
      artifact_id?: never;
      artifact_type?: never;
      call_id?: never;
 ...
 */
export type ArgScope =
  { kind: 'path_prefix'; prefix: string } | { kind: 'command_prefix'; prefix: string };
...
/**  One block of a message. */
export type ContentPart_Deserialize =
  ...
  | ({ kind: 'image'; source: MediaSource; mime: string } & {
      added?: never;
      args?: never;
      artifacts?: never;
      block_kind?: never;
  ...
  | ({ kind: 'document'; source: MediaSource; mime: string; name: string } & {
      added?: never;
      args?: never;
      artifacts?: never;
      block_kind?: never;
   ...
   */
  | ({ kind: 'audio'; source: MediaSource; mime: string } & {
      added?: never;
      args?: never;
      artifacts?: never;
      block_kind?: never;
  ...
  | ({ kind: 'video'; source: MediaSource; mime: string } & {
      added?: never;
      args?: never;
      artifacts?: never;
      block_kind?: never;
  ...
  | ({ kind: 'tool_result'; call_id: CallId; content: ResultPart[]; is_error: boolean } & {
      added?: never;
      args?: never;
      artifacts?: never;
      block_kind?: never;
...
/**  One block of a message. */
export type ContentPart_Serialize =
  | ({ kind: 'text'; text: string } & {
      added?: never;
      args?: never;
      artifacts?: never;
...
export type ErrorDto =
  ...
  | { kind: 'provider'; provider_kind: ProviderErrorKind; message: string }
  | { kind: 'secrets'; message: string }
...
export type InteractionPayload =
  ...
  | { kind: 'access_request'; request: AccessRequest }
  | { kind: 'connector_suggestion'; suggestion: ConnectorSuggestion }
...
export type InteractionResolution =
  ...
  | { kind: 'connector_suggestion'; outcome: SuggestionOutcome }
  | {
      kind: 'elicitation';
  ...
  | { kind: 'skill_proposal'; outcome: SkillProposalOutcome }
  | { kind: 'memory_proposal'; outcome: MemoryProposalOutcome }
...
export type MemoryProposalOutcome =
  { kind: 'saved'; id: MemoryId } | { kind: 'forgotten'; id: MemoryId } | { kind: 'discarded' };
...
export type PermissionDecision =
  ...
  | { kind: 'allow_chat'; scope: GrantScope }
  | { kind: 'deny' };
 ...
 */
export type SkillProposalOutcome =
  { kind: 'saved'; id: string; name: string } | { kind: 'discarded' };
...
export type SuggestionOutcome =
  { kind: 'installed'; instance_id: InstanceId } | { kind: 'declined' };
...
export type VersionSource =
  'model_create' | 'model_update' | 'model_edit' | 'user_edit' | 'user_restore';
